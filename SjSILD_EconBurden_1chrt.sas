...
%include "/_COURSEWORK/ResMeth/AY_2020_2021/LEE_T/Codes/Macro_PSMatch_Multi_2017.sas" /source2;
...
proc ttest data=T.step_6; class stu_g; var age; run;
proc freq data=T.step_6; table stu_g*sex2 /chisq; format sex2 f_sex.; run;
proc freq data=T.step_6; table stu_g*pat_region2 /cmh; format pat_region2 f_pat_region.; run;
proc freq data=T.step_6; table stu_g*index_year /cmh; format index_year f_index_yeargp.; run;
proc freq data=T.step_6; table stu_g*pay_type /cmh; format pay_type f_pay_type.; run;
proc freq data=T.step_6; table stu_g*prd_type /cmh; format prd_type f_prd_type.; run;
proc freq data=T.step_6; table stu_g*CCIcat /cmh; format CCIcat f_CCIcat.; run;
proc freq data=T.step_6; table stu_g*RA_pre /cmh; format RA_pre f_RA_pre.; run;
proc freq data=T.step_6; table stu_g*SLE_pre /cmh; format SLE_pre f_SLE_pre.; run;
proc freq data=T.step_6; table stu_g*SSc_pre /cmh; format SSc_pre f_SSc_pre.; run;
...
*	After PS matching;
ods rtf file="/_COURSEWORK/ResMeth/AY_2020_2021/LEE_T/Report/table2_psm_p.rft" style=analysis;
